...
The Code consist of three models mainly Conditional Random Fields [(CRF)](https://github.com/vkartik2k/STHAL), [Bi-LSTM-CNN](https://github.com/vkartik2k/STHAL) and [BERT](https://github.com/vkartik2k/STHAL). If your are interested in the concept of Fine-grained location identification, I have written on STHAL (to be released soon). 
